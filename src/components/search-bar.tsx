  ...
  return (
    <div className="relative mb-6 w-full w-full" id={`${id}`}>
      <input
        ...
        placeholder={text}
        className={clsx(
          'dark:bg-gray-800 dark:bg-opacity-40 dark:text-gray-100 dark:placeholder-zinc-400 dark:border-rose-50 dark:border-opacity-20 dark:hover:border-gray-400',
